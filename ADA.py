...
# Scale the features for better AdaBoost performance
scaler = StandardScaler()
X_scaled = scaler.fit_transform(X)

# Initialize AdaBoost with Decision Tree as base estimator
ada = AdaBoostClassifier(
    base_estimator=DecisionTreeClassifier(max_depth=2),  # Weak learner with depth 2
    n_estimators=100,  # Number of boosting rounds
    learning_rate=0.5,  # Adjusts contribution of each estimator
    random_state=42
)
